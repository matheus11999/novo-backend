...
const generateInstallRsc = async (req, res) => {
  try {
    ...
    const rscCommands = [
      ...
      `/system ntp client set enabled=yes mode=unicast servers=200.189.40.8,200.221.11.100,a.st1.ntp.br`,
...
const generateUninstallRsc = async (req, res) => {
  try {
    ...
    const rscCommands = [
      ...
      `/ip firewall filter remove [find where in-interface="wg-client"]`,
